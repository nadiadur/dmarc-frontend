  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (err && typeof err === 'object' && 'response' in err) {
        ...
        if (res.status === 403) setError('Anda tidak memiliki akses.')
        else setError(res.data?.detail ?? 'Gagal mengubah password.')
      } else {
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-12 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-300"
              />
                ...
                {showNew ? (
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none"
                    ...
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                      d="M13.875 18.825A10.05 10.05 0 0112 19c-5 0-9.27-3.11-11-7 1.02-2.27 2.7-4.19 4.88-5.52M6.53 6.53A9.956 9.956 0 0112 5c5 0 9.27 3.11 11 7a11.82 11.82 0 01-4.2 5.4M3 3l18 18" />
                  </svg>
                ) : (
                  // eye on
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none"
                ...
                {showConfirm ? (
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none"
                    ...
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                      ...
                      1.02-2.27 2.7-4.19 4.88-5.52M6.53 6.53A9.956 9.956 0 0112 5
                      c5 0 9.27 3.11 11 7a11.82 11.82 0 01-4.2 5.4M3 3l18 18" />
                  </svg>
                ) : (
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
